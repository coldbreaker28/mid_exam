...
class _DrawerPimpinanState extends State<DrawerPimpinan> {
  ...
  Widget build(BuildContext context) {
    ...
    if (currentPage == DrawerSectionsPemilik.home) {
      ...
      _logOut();
    } else if (currentPage == DrawerSectionsPemilik.chart) {
      container = const datetime();
    }
    return Scaffold(
      appBar: AppBar(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          menuItem(3, "Chart", Iconsax.logout,
              currentPage == DrawerSectionsPemilik.chart ? true : false),
        ],
      ),
    );
  }
        ...
        onTap: () {
          ...
          setState(() {
            if (id == 1) {
              ...
              currentPage = DrawerSectionsPemilik.chart;
            }
          });
        },
        child: Padding(
...
enum DrawerSectionsPemilik { home, logout, chart }
