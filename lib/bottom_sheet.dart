...
import 'prod_energi.dart';
import 'power_screen_total.dart';
import 'produksi_energi_screen.dart';
import 'perangkat_list_page.dart';
...
class _BottomSheetMapState extends State<BottomSheetMap> {
  ...
  void initState() {
    ...
    Timer.periodic(const Duration(seconds: 31), (timer) => _updateData());
    //   _updateData();
    // });
  }
